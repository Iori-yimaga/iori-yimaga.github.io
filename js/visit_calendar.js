var visit_calendar = (site_id, access_token, metrics, visit_color) => {
    ...
    var visit_apiurl = 'https://baidu-tongji-apiii.vercel.app/api?site_id=' + site_id + '&access_token=' + access_token + '&method=overview/getTimeTrendRpt' + '&metrics=' + metrics + '&start_date=' + start_date + '&end_date=' + end_date;
  ...
  (function init () {
    ...
    visit_calendar('16940494', '121.74b09fbef96b13ec2d230f35637aae07.YlSNDSx2xhifD5W1_gpN2LayE6EzyDBPXGHhICn.E4sW-w', 'pv_count', visit_color)
  })()